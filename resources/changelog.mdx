...
| Order responses & v2 webhooks | New **`bridge`** object (`provider`, `originNetwork`, `settlementNetwork`, `forward` / `reverse` legs with status, deposit address, amounts, deadline, tx hashes, refunded amount) |
