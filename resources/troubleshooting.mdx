...
<AccordionGroup>
  ...
  <Accordion icon="danger" title="Order Creation Errors">
    ...
    <p>Bridge rails only, and not a Paycrest error — the wallet is refusing before broadcast. <code>amountToTransfer</code> covers the transfer, never the origin chain's gas.</p>
    <ul>
