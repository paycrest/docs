...
`GET /v2/tokens` marks a rail with two extra fields. A token without them is a native network. The examples on this page use the Solana USDC rail settling on Base.
