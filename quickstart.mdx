...
The rate endpoint is public (no API key needed). Fetch a fresh rate immediately before creating each order.
...
func main() {
    resp, _ := http.Get("https://api.paycrest.io/v2/rates/USDT/100/NGN?network=base")
